...
/**
 * Enviar mensagem HSM de suporte para +351961725398
 */
...
echo "📱 Enviando mensagem HSM de Suporte\n";
echo str_repeat("━", 60) . "\n\n";

// Template: suporte (pt_BR)
// Mensagem: "Olá! A nossa conversação anterior terminou. Responda "Sim" para voltar a falar e terminar a contratação do seu plano."
...
echo "De:         +$sender\n";
echo "Para:       +$recipient\n";
echo "Template:   suporte\n";
echo "Idioma:     pt_BR\n";
echo "Categoria:  MARKETING\n\n";

echo "📝 Mensagem:\n";
echo "\"Olá! A nossa conversação anterior terminou. Responda \"Sim\" para voltar a falar e terminar a contratação do seu plano.\"\n\n";
...
if ($httpCode === 200) {
    ...
    if (isset($result['messages'][0])) {
        ...
        echo "📱 Verifique o seu WhatsApp (+351961725398)\n";
        echo "💬 Você deve receber a mensagem em alguns segundos\n\n";
